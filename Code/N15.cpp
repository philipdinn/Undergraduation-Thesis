...
int flag = 0;
AccelStepper mystepperX(1, StepX, DirX, ena); // 1 là chế độ dùng Driver
AccelStepper mystepperY(1, StepY, DirY, ena); // 1 là chế độ dùng Driver
AccelStepper mystepperZ(1, StepZ, DirZ, ena); // 1 là chế độ dùng Driver
